...
export const usePhotoboothStore = defineStore("photobooth", () => {
  ...
  // connection and uses placeholder captures instead — lets the whole
  // flow (template → payment → camera → print → QR) be walked through
  // without the physical camera. Toggle in Settings → Camera.
