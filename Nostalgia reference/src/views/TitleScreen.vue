 ...
 * seconds opens the admin panel. If an admin PIN has been set in
 * Settings, a PIN pad is shown first; otherwise it goes straight
 * through (matches the prior no-login default for a booth that runs
 * on-prem on operator-controlled hardware).
 */
