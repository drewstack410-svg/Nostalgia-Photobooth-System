...
const props = withDefaults(
  defineProps<{
    ...
    activeIndex?: number;
    /** Box the real sheet is contain-fit into, in px. */
    maxWidth?: number;
    maxHeight?: number;
  }>(),
  { photos: () => [], activeIndex: -1, maxWidth: 420, maxHeight: 620 },
);
...
// ratio (the flaw in the old 4:3 placeholder frames).
